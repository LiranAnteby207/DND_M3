...
public class InputFromUser {
    ...
    public static final char CastAbility = 'e';

    public static final char Wait = 'q';
//    public static final char JonSnow = '0';
//    public static final char TheHound ='1';
//    public static final char Melisandre = '2';
//    public static final char ThorosofMyr = '3';
//    public static final char AryaStark = '4';
//    public static final char Bronn = '5';
    public static char getStep(String nextStep){
        if(nextStep.charAt(0) == Wait)
            return Wait;
